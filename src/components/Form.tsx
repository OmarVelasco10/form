    ...
    <div className="bg-white px-10 py-20 rounded-3xl border-2 border-gray-100">
      ...
      <form className="mt-8" onSubmit={handleSubmit(onSubmit)}>
        <div>
          ...
          {errors.email?.type === 'pattern' && <p className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">The email format is incorrect</p>}
        ...
        <div className="mt-8 flex flex-col gap-y-4">
          <input type="submit" className="active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all  py-3 rounded-xl bg-violet-500 text-white text-lg font-bold" value="Sigin"/>
           
          <button className="flex rounded-xl py-3 border-2 border-gray-100 item-center justify-center gap-2 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all ">
            <svg
